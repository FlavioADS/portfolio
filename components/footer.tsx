...
export default function Footer() {
  ...
  const socials = [
    { label: "GitHub", href: "https://github.com/flavioADS", icon: <FaGithub /> },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/flavioads", icon: <FaLinkedin /> },
    { label: "Instagram", href: "https://www.instagram.com/f_araaujo/", icon: <FaInstagram /> },
  ];
        ...
        <div className="mx-auto max-w-6xl px-6 py-10">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
            <div className="md:col-span-5">
              <div className="flex items-center gap-3">
                <div>
                  <p className="text-base font-semibold text-black/90 dark:text-white"> Flávio de Araújo Silva</p>
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-black/10 dark:border-white/10 pt-6 md:flex-row md:items-center md:justify-between">
            <p className="text-xs text-black/55 dark:text-white/55">
              © {year} Flávio de Araújo Silva | {t("footer.rights")}
            </p>
